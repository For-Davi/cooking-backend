...
class CreateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'variants.*.minStockQuantity' => 'required|integer|min:0',
    ...
    public function messages(): array
    {
        return [
            ...
            'variants.*.minStockQuantity.required' => 'O estoque mínimo é obrigatório.',
            'variants.*.minStockQuantity.integer' => 'O estoque mínimo deve ser um número inteiro.',
            'variants.*.minStockQuantity.min' => 'O estoque mínimo não pode ser negativo.',
